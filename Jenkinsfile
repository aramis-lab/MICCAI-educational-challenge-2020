      ...
      stage('Build') {
        ...
        steps {
          ...
          sh '''#!/usr/bin/env bash
             ...
             sed -i 's+github/aramis-lab/MICCAI-educational-challenge-2020/blob/master/Notebooks-AD-DL+github/aramis-lab/Notebooks-AD-DL/blob/master+g' _build/html/Notebooks-AD-DL/*.html
             conda deactivate
             '''
